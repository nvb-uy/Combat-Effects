...
public class DataHolders {
    ...
    public static class EntityHolder {
        ...
        private EntityHolder(String entity_regex, List<EffectHolder> effects_to_apply, int minimum_hp, boolean only_on_player_hit, boolean apply_to_attackers_instead) {
            ...
            this.apply_to_attackers_instead = apply_to_attackers_instead;
        }
        ...
        public boolean apply_to_attackers_instead = false;
    }
}
