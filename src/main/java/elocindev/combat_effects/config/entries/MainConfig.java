...
public class MainConfig {
    ...
    @Comment("    * This is useful to make an entity apply bleeding to the player, for example.")
    @Comment("  - apply_to_entity_instead_of_player: If true, the effects will be applied to the entity instead of the player.")
	@Comment(" ")
	@Comment("-------------------------------------------------------------------------------------------------------------------------")
    @Comment(" ")
